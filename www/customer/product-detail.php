    ...
    <?php if ($product[0] == $productId) : ?>
        ...
        <section class="container d-flex bg-white w-75 align-self-center flex-column rounded shadow outside-box">
            ...
            <div class="row">
                <div class="col-sm-7">
                    <div class="pic">
                        <img class="itemPicPath" src="../products-images/<?php echo $location; ?>" alt="">
                    </div>
                </div>
                <div class="col-sm">
                    <h1 id="itemName"><?php echo $product[2] ?></h1>
                    <hr>
                    ...
                    <button class="btn btn-primary btn-lg" id="addToCart" type="submit">Add to Cart</button>
                </div>
